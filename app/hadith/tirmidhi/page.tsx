...
const hadiths = [
  {
    ...
    source: "جامع الترمذي، حديث رقم 1987",
  },
  {
    number: 2,
    text: "من لا يرحم لا يُرحم.",
    source: "جامع الترمذي، حديث رقم 1922",
  },
  {
    number: 3,
    text: "لا ضرر ولا ضرار.",
    source: "جامع الترمذي، حديث رقم 1940",
  },
];
  ...
  return (
    <main dir="rtl" className="min-h-screen bg-stone-50 px-4 py-10 text-stone-900 dark:bg-stone-950 dark:text-stone-100">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mb-3 text-4xl font-bold">جامع الترمذي</h1>

        <p className="mb-8 leading-8 text-stone-700 dark:text-stone-300">
          قسم خاص بجامع الإمام الترمذي رحمه الله، مع بيان درجة الحديث عند
          إدخال البيانات النهائية.
        </p>
